...
<?php echo form_open_multipart('settings', array('id' => 'settingsform', 'onsubmit' => 'return requiredFields("");'));?>
	...
	<div id="settings_sections">
		<div class="controls">
			...
			<a href="#expense_settings" id="expense_settings_menu"><?php echo $this->lang->line('settings_expense_settings');?></a>
		...
		<div class="scroller">
			<div class="content">
				...
				<div class="section" id="expense_settings">
					...
					<p>
						<label for="expense_note_default"><span><?php echo $this->lang->line('settings_default_Expense_note');?> <br /><?php echo $this->lang->line('settings_note_max_chars');?></span></label>
