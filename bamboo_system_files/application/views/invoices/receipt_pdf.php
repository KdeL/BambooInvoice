<?php
/**
 * This file is essentially a fully paid invoice precented as a receipt.
...
<body>
	...
	<table>
		<tr>
			<td width="60%">
				<p>
					<strong>
						<?php echo $this->lang->line('invoice_date_last_payment').':';?> <?php echo $date_last_payment;?><br />
					</strong>
						<?php echo $this->lang->line('invoice_invoice').':';?> <?php echo $row->invoice_number;?><br />
						<?php echo $this->lang->line('invoice_date').':';?> <?php echo $date_invoice_issued;?><br />
						<?php echo $this->lang->line('invoice_billed_to').':';?>
						<?php if ($row->name != '') {echo $row->name.'<br />';}?>
	...
	<h3 class="receipt_title">
		<?php echo $this->lang->line('invoice_receipt');?>
	</h3>
	...
	<span class="receipt_amount_paid">
		<?php echo $total_paid;?>
	</span>
	</p>
	...
	<div id="footer">
		<?php if ($this->settings_model->get_setting('display_branding') == 'y'):?>
			<p>
				<?php echo $this->lang->line('invoice_receipt_generated_by');?> 
