...
<p><?php echo anchor('expensereports', $this->lang->line('expensereports_back_to_reports'));?></p>

<h3><?php echo $expensereport_dates;?></h3>
<p><strong>
<?php if(isset($client_name))echo $client_name;?><br/>
<?php if(isset($vendor_name))echo $vendor_name;?>
</strong></p>
<?php
/**
