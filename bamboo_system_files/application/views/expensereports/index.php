...
<div id='div_generate_report'>
<h3><?php echo $this->lang->line('reports_generate_report');?></h3>
<p id="report_shortlinks"><?php echo anchor ("expensereports/dates/$current_year-01-01/$current_year-03-31/", $this->lang->line('expensereports_first_quarter'));?>, <?php echo anchor ("expensereports/dates/$current_year-04-01/$current_year-06-30/", $this->lang->line('expensereports_second_quarter'));?>, <?php echo anchor ("expensereports/dates/$current_year-07-01/$current_year-09-31/", $this->lang->line('expensereports_third_quarter'));?>, <?php echo anchor ("expensereports/dates/$current_year-10-01/$current_year-12-31/", $this->lang->line('expensereports_fourth_quarter'));?></p>

<?php echo form_open('expensereports/dates');?>
<p><label for="startDate"><?php echo $this->lang->line('reports_start_date');?> <input type="text" id="startDate" size="10" name="startDate" value="<?php echo date("Y-m-d", mktime(0,0,0,1,1,date('Y')));?>" /></label></p> 
<p><label for="endDate"><?php echo $this->lang->line('reports_end_date');?> <input type="text" id="endDate" size="10" name="endDate" value="<?php echo date("Y-m-d");?>" /></label></p>
<p><label><?php echo $this->lang->line('expense_select_client');?>
...
<p><label><?php echo $this->lang->line('expense_select_vendor');?>
...
<p><input type="submit" value="<?php echo $this->lang->line('reports_generate_report');?>" /></p>
</form>
</div>
<div id='div_yearly_expenses'>
<h3><?php echo $this->lang->line('expensereports_yearly_expense').' '.$current_year;?></h3>
<p>
	<?php
	foreach ($years as $year)
	{
		echo anchor('expensereports/index/'.$year, $year) . ' ';
	}
	?>
</p>
 ...
 */
			...
			var dataset = {
				'<?php echo $this->lang->line('menu_expenses');?>': 	[<?php
foreach ($month_expenses as $key => $value) {
	if ($value == '') {$value = 0;}
	echo '[' . ($key-1) . ', ' . $value . ']';
		if ($key <= 11) {
			echo ",";
...
<?php endif; ?>
<?php echo $yearToDateTotal;?>
<?php endif; ?>
</ul>
</div> <!-- div_yearly_expenses -->
<?php
